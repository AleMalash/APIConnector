...
public class ViewStatistics extends RelativeLayout {
    ...
    public void populate(Player player) {
        ...
        rightNickname.setText(player.getNickname());
        rightRegistered.setText(player.getRegistered());
        rightBattles.setText(player.getBattles());
        rightRating.setText(player.getRating());
        rightPercentWinRating.setText(player.getPercentWinRating());
        rightPercentHitsDeal.setText(player.getPercentHitsDeal());
        rightDamageFactor.setText(player.getDamageFactor());
        rightAverageDamage.setText(player.getAverageDamage());
        rightPercentSurvived.setText(player.getPercentSurvived());
        rightFragsFactor.setText(player.getFragsFactor());
        rightMaxExperience.setText(player.getMaxExperience());
        rightAverageExperience.setText(player.getAverageExperience());
        rightMaxDamage.setText(player.getMaxDamage());
